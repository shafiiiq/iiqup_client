...
import { fetchHireOrders, deleteHireOrder } from '../api/hro.list.api';
import './HroList.css';
...
function HroList() {
  ...
  const fetchHireOrdersList = async () => {
    try {
      ...
      console.error('[HroList] error:', error);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDelete = async (ref) => {
    try {
      ...
      console.error('[HroList] delete error:', error);
    }
  };
