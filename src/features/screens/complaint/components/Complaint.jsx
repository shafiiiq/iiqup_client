// ─────────────────────────────────────────────────────────────────────────────
// Complaint.jsx — Complaint management dashboard.
...
import { fetchComplaints as fetchComplaintsService, getPreSignedMediaUrl } from '../api/complaints.api';
...
// ─────────────────────────────────────────────────────────────────────────────
// Complaint — Main Component
// ─────────────────────────────────────────────────────────────────────────────

/**
 * Complaint — Full complaints dashboard with auto-refresh, media carousel,
                          ...
                          <div className="complaint-media-viewer">
                            ...
                            <div className="complaint-media-container">
                              <AsyncMedia
                                ...
                                controls
                                preload="metadata"
                                onError={(e) => console.error('[Complaint] media error:', e.target?.error?.message)}
                              />
                            </div>
                            ...
                            <div className="solution-media">
                              <div className="solution-media-item">
                                <AsyncMedia
                                  ...
                                  controls
                                  preload="metadata"
                                  onError={(e) => console.error('[Complaint] solution media error:', e)}
                                />
                              </div>
                            </div>
                          </div>
