            ...
            <SidebarSection title="Actions" gap="6px" titleFontSize="27px" titleFontWeight="500" titleColor="var(--white-200)">
              <SidebarActions
                ...
                buttons={[
                  ...
                  { label: 'Delete Stock',  onClick: () => deleteStockEntry(selectedStock._id), colorScheme: 'red-800',     textColor: 'white-100', squircle: '6xl', font: 'xl', height: '45px', width: '24%' },
                ]}
              />
            </SidebarSection>
          </>
