// ─────────────────────────────────────────────────────────────────────────────
// MaintenanceHistory.jsx — Shell component. Composes hooks and sub-components.
...
// Hooks
import { useServiceData }     from '../hooks/useHistory';
import { useDocumentSigning } from '../hooks/useHistorySign';

// Components
import ServiceTable from './widgets/HistoryTable';

// Exports
import { exportToExcel, exportToPDF, exportToPDFSeparate, printServiceHistory } from '../helper/history.export.helper';
...
const MaintenanceHistory = () => {
  ...
  const handleViewAllDocuments = () => {
    ...
    const { formatDate } = require('../helper/history.helper');
