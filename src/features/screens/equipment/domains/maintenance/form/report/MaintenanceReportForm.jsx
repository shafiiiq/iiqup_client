// ─────────────────────────────────────────────────────────────────────────────
// MaintenanceReportForm.jsx — Service report form for adding and updating service records.
...
import { fetchEquipmentByRegNo, fetchHistoryById, fetchReportById } from '../../history/api/maintenance.history.api';
import { saveServiceReport, updateServiceReport } from './api/maintenance.report.api';
...
// ─────────────────────────────────────────────────────────────────────────────
// MaintenanceReportForm — Main Component
// ─────────────────────────────────────────────────────────────────────────────
 ...
 */
function MaintenanceReportForm({ initialData = {} }) {
  ...
  useEffect(() => {
    ...
    const fetchHistory = async () => {
      try {
        ...
        console.error('[MaintenanceReportForm] fetchHistory:', err);
  ...
  useEffect(() => {
    ...
    const fetchReport = async () => {
      try {
        ...
        console.error('[MaintenanceReportForm] fetchReport:', err);
  ...
  useEffect(() => {
    ...
    const fetchEquipment = async () => {
      try {
        ...
        console.error('[MaintenanceReportForm] fetchEquipment:', err);
      }
    };
  ...
  const handleRemarksChange = (e) => {
    ...
    grammarDebounceRef.current = setTimeout(async () => {
      ...
      try {
        ...
        console.error('[MaintenanceReportForm] grammar check:', err);
      }
    }, 1500);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { result } = isUpdateMode ? await updateServiceReport(reportId, payload) : await saveServiceReport(payload);
      ...
      console.error(`[MaintenanceReportForm] ${isUpdateMode ? 'update' : 'add'}:`, err);
      showAlert(
        isUpdateMode
