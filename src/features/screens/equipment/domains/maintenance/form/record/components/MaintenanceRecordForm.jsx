...
// ─────────────────────────────────────────────────────────────────────────────
// MaintenanceRecordForm.jsx  —  All-or-nothing batch entry for service history records.
...
import { saveBatchServiceHistory } from '../api/maintenance.record.api';
...
function MaintenanceRecordForm() {
  ...
  useEffect(() => {
    ...
    const fetchEquipment = async () => {
      ...
      } catch (err) { console.error('[MaintenanceRecordForm] fetchEquipment:', err); }
    };
    fetchEquipment();
