// ─────────────────────────────────────────────────────────────────────────────
// MaintenanceHistoryForm.jsx — Unified entry form for all five service history
// ─────────────────────────────────────────────────────────────────────────────
...
import { createServiceHistory }        from './api/maintenance.history.api';
...
import './MaintenanceHistoryForm.css';
...
function MaintenanceHistoryForm() {
  ...
  useEffect(() => {
    ...
    const fetchEquipment = async () => {
      try {
        ...
        console.error('[MaintenanceHistoryForm] fetchEquipment:', err);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('[MaintenanceHistoryForm] handleSubmit:', err);
