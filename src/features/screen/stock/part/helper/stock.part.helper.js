...
export const calculateStatus = (stockCount) => {
...
export const buildStockReportWorkbook = (stocks, filteredStocks) => {
...
export const generateStockReportFilename = () => {
  const now = new Date();
  ...
  return `All_Stock_Report_${dateStr}_${timeStr}.xlsx`;
};

export const exportWorkbookAsExcelFile = async (workbook, filename) => {
