...
import { getOperatorName, formatDate, formatDateWithExpiry } from '../../helper/equipment.helper';
...
function EquipmentSidebar({
  ...
  const renderContent = ({ pushScreen }) => {
    ...
    if (content.type === 'details') {
      ...
      return (
        <>
          <SidebarSection title="Basic Information" gap="6px" titleFontSize="27px" titleFontWeight="500" titleColor="white-200">
            <SidebarRow label="Machine"         value={String(item.machine || '')}  labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="Registration No" value={String(item.regNo || '')}    labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="Brand"           value={String(item.brand || '')}    labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="Year"            value={String(item.year || '')}     labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="Company"         value={String(item.company || '')}  labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="Status"          value={String(item.status || '')}   labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
          </SidebarSection>
          ...
          <SidebarSection title="Location & Assignment" gap="6px" titleFontSize="27px" titleFontWeight="500" titleColor="var(--white-200)">
            <SidebarRow
              ...
              colorScheme="primary-700" variant="gradient" squircle={true} radius="130px"
              action={!isSelectMode ? { label: 'Replace Site', onClick: () => onViewDetails(item), colorScheme: 'primary-300', textColor: 'black-200', squircle: '4xl', font: 'lg', height: '40px' } : null}
            />
            <SidebarRow
              ...
              labelFontSize="22px" valueFontSize="24px"
              colorScheme="primary-700" variant="gradient" squircle={true} radius="130px"
              action={!isSelectMode ? { label: 'Replace Operator', onClick: (e) => onReplaceOperator(e, item), colorScheme: 'primary-300', textColor: 'black-200', squircle: '4xl', font: 'lg', height: '40px' } : null}
            />
            {item.lastCertificationBody?.length > 0 && (
              <SidebarRow
                ...
                action={!isSelectMode ? {
                      ...
                      content: (
                        <SidebarSection title="All Operators" gap="6px" titleFontSize="27px" titleFontWeight="500" titleColor="var(--white-200)">
                          <SidebarTable
                            ...
                            headColor="white-200" rowColor="white-200"
                  ...
                  colorScheme: 'primary-300', textColor: 'black-200', squircle: '4xl', font: 'lg', height: '40px'
                } : null}
              />
            )}
          </SidebarSection>
          ...
          <SidebarSection title="Mobilization History" gap="6px" titleFontSize="27px" titleFontWeight="500" titleColor="var(--white-200)">
            {item.mobDate ? (
              ...
              <SidebarRow label="Mobilized" value="No mobilization history" labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            )}
            {item.demobDate ? (
              <SidebarRow
              ...
              <SidebarRow label="Demobilized" value="No demobilization history" labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            )}
          </SidebarSection>

          <SidebarSection title="Expiry Information" gap="6px" titleFontSize="27px" titleFontWeight="500" titleColor="var(--white-200)">
            <SidebarRow label="Istimara Expiry"  value={istimaraInfo.formattedDate || 'N/A'} labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="Insurance Expiry" value={String(item.insuranceExpiry || 'N/A')} labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="TPC Expiry"       value={String(item.tpcExpiry || 'N/A')}       labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
          </SidebarSection>
    ...
    if (content.type === 'fuels') {
      if (!content.data.length) return (
        <SidebarSection title="Fuel Consumption" gap="6px" titleFontSize="27px" titleFontWeight="500" titleColor="var(--white-200)">
          <SidebarRow label="Data" value="No fuel consumption data available." labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
        </SidebarSection>
      );
      ...
      return (
        <>
          <SidebarSection title="Fuel Consumption Summary" gap="6px" titleFontSize="27px" titleFontWeight="500" titleColor="var(--white-200)">
            <SidebarRow label="Total Liters"       value={`${fuelData.totalLiters || 0} L`}        labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="Total Amount"       value={`QAR ${fuelData.totalAmount || 0}`}       labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
            <SidebarRow label="Total Transactions" value={String(fuelData.totalTransactions || 0)}  labelFontSize="22px" valueFontSize="24px" colorScheme="primary-700" variant="gradient" squircle={true} radius="130px" />
          </SidebarSection>
