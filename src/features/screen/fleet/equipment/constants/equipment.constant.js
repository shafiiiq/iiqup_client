...
export const EQUIPMENT_ALL_SITES_FILTER = 'all';
...
export const EQUIPMENT_DEFAULT_TAB_COUNTS = {
  own: { total: 0, active: 0, idle: 0, maintenance: 0, sold: 0 },
  hired: 0,
  leased: 0,
  ansariStaff: 0,
  sites: 0,
...
export const EQUIPMENT_IDLE_AT_OPTIONS = [
