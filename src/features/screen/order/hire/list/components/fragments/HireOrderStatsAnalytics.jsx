...
function HireOrderStatsAnalytics({ series, loading }) {
    if (loading || !series) {
        return <div className="hire order stats empty"><p>Loading analytics…</p></div>;
    }

    return (
        <div className="hire order stats analytics">
            <div className="hire order stats chart-card">
                <div className="hire order stats chart-header">
                    ...
                    <p>Compare hire order volume against total spend per bucket</p>
                </div>
            ...
            <div className="hire order stats table-card">
                <div className="hire order stats chart-header">
                ...
                <Table
                    ...
                    data={series.buckets || []}
                    rowKey={(b) => b.label}
                    emptyMessage="No hire orders for this period"
                />
            </div>
        </div>
    );
...
export default HireOrderStatsAnalytics;