 ...
 */
function HireOrder({ edit, amendment, amendmentEdit }) {
  ...
  const fetchLatestHireOrderNumber = async () => {
    try {
      ...
      console.error('[HireOrder] fetchLatestHireOrderNumber error:', error);
  ...
  const fetchHireOrderForEdit = async () => {
    ...
    try {
      ...
      console.error('[HireOrder] fetchHireOrderForEdit error:', error);
  ...
  const fetchHireOrderForAmendmentEdit = async () => {
    ...
    try {
      ...
      console.error('[HireOrder] fetchHireOrderForAmendmentEdit error:', error);
      setSaveStatus('Error loading hire order data');
    } finally {
      setIsLoading(false);
    }
  ...
  const saveHireOrderData = async () => {
    ...
    try {
      ...
      console.error('[HireOrder] saveHireOrderData error:', error);
