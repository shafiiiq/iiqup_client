// ─────────────────────────────────────────────────────────────────────────────
// FileViewer.jsx — Native-feel file preview window
...
//   • Supports: image, PDF, video, audio, text/code, staff, unknown
...
const getFileCategory = (file) => {
  ...
  if (['xlsx','xls','docx','doc','pptx','ppt'].includes(ext))               return 'staff';
  return 'unknown';
};
 ...
 */
const FileViewer = ({ file, objectUrl, textContent, onClose, onDownload }) => {
    ...
    >
      ...
      >
        ...
        <div className="viewer__body">
          ...
          {category === 'staff'  && <StaffPreview  name={file.name} ext={ext} />}
